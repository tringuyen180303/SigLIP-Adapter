...
data:
  ...
  shots: 2               # few‑shot per class for cache
  overwrite: false
...
class OxfordPetsDataset(DatasetBase):
    def __init__(self, root, split='train', num_shots=0, transform=None, val_ratio=0.2, seed=42):
    ...
    def _summ(self,txt):
        ...
        return self.s_tok.decode(ids[0], skip_special_tokens=True)
...
if __name__=='__main__':
    ...
    train_loader_F = DataLoader(train_ds, batch_size=cfg['training']['batch_size'], shuffle=True, num_workers=0)
