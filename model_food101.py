...
def main():
    ...
    val_dataset = Food101Dataset(root_path, split='val', transform=transform, val_ratio=0.1)
    test_dataset = Food101Dataset(root_path, split='test', transform=transform, val_ratio=0.1)
    ...
    # Build cache loader
    train_dataset = Food101Dataset(root_path, split='train', transform=transform, num_shots=cfg['data']['shots'])
